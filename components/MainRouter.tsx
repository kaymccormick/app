...
export default class MainRouter extends React.Component<MainRouterProps> {
    public render() {
        ...
        return <Router basename="/entityView"><MainViewLayout app={this.props.app!} store={this.props.store} site={this.props.site} renderMainView={() => <React.Suspense fallback={<div>loading</div>}>{routes}</React.Suspense>}/></Router>;
    }
}

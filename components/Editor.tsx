...
export default class MyEditor extends React.Component<Props, State> {
  state: State = { popOverIsOpen: false,
  rawContent: convertToRaw((EditorState.createEmpty()).getCurrentContent()),
  editorState: EditorState.createEmpty(),
  input:'',
  };
  private handleKeyCommand: (command: EditorCommand, editorState: EditorState)
    => DraftHandleValue;
  private mapKeyToEditorCommand:
    (e: KeyboardEvent<Element>) => EditorCommand | null;
  ...
  _publish() {
    const blocksFromHTML: {contentBlocks: Array<ContentBlock>, entityMap: any } = convertFromHTML('<emphasis>hi</emphasis>');
